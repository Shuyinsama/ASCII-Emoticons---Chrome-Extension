		...
		xhr.onreadystatechange = function() {
			if(xhr.readyState == 4) {
				...
				for (i in response) {
					...
					container.append('<tr id="copy-ascii"><td class="cat-bar"><span class="'+data.category.toLowerCase()+'-cat">'+data.category.toLowerCase()+'</span></td><td>'+data.regex+'</td><td id="asciiToCopy">'+data.ascii+'</td></tr>');
				}
			}
		}
		xhr.send();
